...
<%@include file="./indexjsp/banner.html" %>
</div>

<div class="resp_wrap display_wrap">
   <%@ include file="./indexjsp/collection.html" %>
...
<div class="full_bnr">
<%-- <%@include file="./indexjsp/av.html" %> --%>
    <!--신상품 광고 파트 av.html-->
</div>
<div class="full_bnr2">

<%-- <%@include file="./indexjsp/av2.html" %> --%>
   <!--이벤트 광고 파트 av2.html-->
</div>

<div class="resp_wrap display_wrap">
<%-- <%@include file="./indexjsp/newproduct.html" %> --%>

</div>

<div class="resp_wrap display_wrap">
<%-- <%@include file="./indexjsp/bestproduct.html" %> --%>
    <!-- bestproduct.html-->
</div>
